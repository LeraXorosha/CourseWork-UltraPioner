...
namespace UltraPioner.Models
{
    ...
    public static class ModelBuilderExtensions
    {
        ...
        public static ModelBuilder AddInitialData(this ModelBuilder modelBuilder)
        {
            ...
            {
                new Standart {Id = 1, StandartName = "Отжимания", StandartResult = 56, DateResult = new DateTime(2022,12,13), ProfilePlayerId = 1, TypeStandart = "Max"},
                ...
                new Standart {Id = 4, StandartName = "Кросс 100 м/c", StandartResult = 10.9 ,DateResult = new DateTime(2023, 12, 13), ProfilePlayerId = 1, TypeStandart = "Min"},
                new Standart {Id = 28, StandartName = "Кросс 300 м/c", StandartResult = 37.4 ,DateResult = new DateTime(2023, 12,13), ProfilePlayerId = 1, TypeStandart = "Min"},
                new Standart { Id = 29, StandartName = "Кросс 500 м/c", StandartResult = 61.4, DateResult = new DateTime(2023, 12, 13), ProfilePlayerId = 1, TypeStandart = "Min" },
                ...
                new Standart {Id = 5, StandartName = "Отжимания", StandartResult = 89, DateResult = new DateTime(2023, 12, 13), ProfilePlayerId = 2, TypeStandart = "Max"},
                ...
                new Standart {Id = 13, StandartName = "Отжимания", StandartResult = 189,DateResult = new DateTime(2022,9,21), ProfilePlayerId = 2, TypeStandart = "Max"},
                new Standart {Id = 14, StandartName = "Пресс", StandartResult = 195,DateResult = new DateTime(2023,9,21), ProfilePlayerId = 2, TypeStandart = "Max"},
                new Standart {Id = 15, StandartName = "Подтягивание", StandartResult = 152,DateResult = new DateTime(2023,9,21), ProfilePlayerId = 2, TypeStandart = "Max"},
                new Standart {Id = 16, StandartName = "Кросс 100 м/c", StandartResult = 114.4 ,DateResult = new DateTime(2023, 9, 21), ProfilePlayerId = 2, TypeStandart = "Min"},
                ...
                new Standart {Id = 9, StandartName = "Отжимания", StandartResult = 89,DateResult = new DateTime(2023, 12, 13), ProfilePlayerId = 3, TypeStandart = "Max"},
                new Standart {Id = 10, StandartName = "Пресс", StandartResult = 95,DateResult = new DateTime(2023, 12, 21), ProfilePlayerId = 3, TypeStandart = "Max"},
                new Standart {Id = 11, StandartName = "Подтягивание", StandartResult = 52,DateResult = new DateTime(2023, 12, 13), ProfilePlayerId = 3, TypeStandart = "Max"},
                new Standart {Id = 12, StandartName = "Кросс 100 м/c", StandartResult = 14.4 ,DateResult = new DateTime(2023, 12, 13), ProfilePlayerId = 3, TypeStandart = "Min"},
                ...
                new Standart {Id = 22, StandartName = "% выигранных сбросов", StandartResult = 98 ,DateResult = new DateTime(2023, 12, 13), ProfilePlayerId = 3, TypeStandart = "Max"},
            };
